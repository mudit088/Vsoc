...
const About = () => {
  return (
    <div name='About' className=" bg-gradient-to-b from-white to-orange-700">
    
    <div className='pt-10'>
    <h1 className=" font-display text-orange-900 text-center font-Vsoc  text-3xl font-extrabold leading-none tracking-tight md:text-5xl  lg:text-6xl lg:mb-24">
       About
      </h1>
    </div>
    <div className=' md:m-0 flex justify-center items-center'>
    <section className='px-4 sm:px-56 py-0 sm:pb-10  rounded-2xl shadow-xl shadow-white '>
